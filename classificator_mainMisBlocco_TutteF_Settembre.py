...
def main():
    pi_dict = dict()
    tipoCell ='nucleus'
    pickle_dir = "./generated_pickle_files_interval_avg"+tipoCell
            ...
            for file in files:
                ...
                for k in pi_dict.keys():
                    if prima :
                        ...
                        ###f_totB = pi_dict[k]['freq'][:, s - 1]
                        xx_tot = np.concatenate( (f_totA, xx_tot), axis= 1)
